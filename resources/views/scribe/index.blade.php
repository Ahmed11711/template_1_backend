                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-v1-users">POST api/v1/users</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-users--user-">
                                <a href="#endpoints-GETapi-v1-users--user-">GET api/v1/users/{user}</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-v1-users--user-">DELETE api/v1/users/{user}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;status&quot;: true,
    &quot;message&quot;: &quot;Data retrieved via Pipeline&quot;,
    &quot;data&quot;: [
        {
            &quot;id&quot;: 1,
            &quot;name&quot;: &quot;password&quot;,
            ...
            &quot;password&quot;: &quot;$2y$12$DmibzELczdPbhgQhUKuq4u2Nay6kQlPcKloag1F8bkmuNFE4tiq3e&quot;,
            &quot;remember_token&quot;: null,
            &quot;created_at&quot;: &quot;2026-03-31T09:00:16.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2026-03-31T09:00:16.000000Z&quot;
        }
    ],
    &quot;meta&quot;: {
        &quot;current_page&quot;: 1,
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-users--user-">GET api/v1/users/{user}</h2>
...
<span id="example-requests-GETapi-v1-users--user-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-v1-users--user-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-users--user-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-users--user-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-users--user-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-users--user-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-users--user-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-users--user-" data-method="GET"
      data-path="api/v1/users/{user}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-users--user-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-users--user-"
                    onclick="tryItOut('GETapi-v1-users--user-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-users--user-"
                    onclick="cancelTryOut('GETapi-v1-users--user-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-users--user-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-users--user-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-users--user-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               step="any"               name="user"                data-endpoint="GETapi-v1-users--user-"
               value="1"
               data-component="url">
    <br>
...
<p>The user. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-users--user-">DELETE api/v1/users/{user}</h2>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="user"                data-endpoint="DELETEapi-v1-users--user-"
               value="1"
               data-component="url">
    <br>
<p>The user. Example: <code>1</code></p>
